...
var watchYFactor = 0.54; // Watchface Y position = windowHeight * watchYFactor; Bigger watchYFactor makes the watchface vertical lower.
var scaleKFactor = 1; // ScaleK = windowWidth / scaleKFactor; Bigger scaleKFactor makes everything bigger.
var globalFontSize = 14; // font size of time
...
function basicUi() {
  ...
  fill(255);
  noStroke();
  text(DisplayH + ":" + DisplayM + ":" + DisplayS, ((windowWidth * 3 / 14) - (windowWidth / diaFactor / 2)), (windowHeight / 5));
